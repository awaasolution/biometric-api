...
const storage = multer.diskStorage({
    ...
    filename: (req, file, cb) => {
        ...
        const fileName = "realtimePhoto" + fileExtension; // Generate unique filename using timestamp
...
router
    .route('/:id')
    .post(upload.single('photo'), faceCompareController.compareRealTimeWithPython)
